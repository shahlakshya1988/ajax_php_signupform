    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Linkedin</h5>
            ...
            <div class="modal-body">
                <form action="">
                    <div class="form-group">
                        <input type="text" name="linkedin_input" id="linkedin_input" class="form-control profile_input" placeholder="Enter Linkedin Account...">
